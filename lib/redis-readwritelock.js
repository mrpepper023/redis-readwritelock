...
(function() {
  var cs, init, isconflictrangelock, lockconfig, locklog, locks, multilock, pwrlock, randomwait, randsleep, rangelocks, rangepwrlock, rangepwrlock_shrink, rangereaderlock, rangereaderlock_shrink, rangewriterlock, rangewriterlock_shrink, rcli, readerlock, redis, regist_uselocks, resetrangelockname, rwlocks, simplelock, testA, testB, testC, testD, testrangeA, testrangeB, testrangeC, testrangeD, testrwA, testrwB, testrwC, testrwD, unlock, uselocks, writerlock,
  ...
  randomwait = function(waittimeobj, next) {
    ...
    return setTimeout(next, Math.floor(waittimeobj.time));
  };
  ...
  module.exports.init = init = function(config, next) {
    var ref, ref1;
    lockconfig = config;
  ...
  module.exports.multilock = multilock = function(objectarray, next) {
    var j, len, lockargs, lockobj, obj, waittimeobj;
    waittimeobj = {
      time: lockconfig.waitmin
    };
    lockobj = {};
    ...
    lockobj['obj'] = [];
    lockargs = [];
    for (j = 0, len = objectarray.length; j < len; j++) {
      obj = objectarray[j];
  ...
  randsleep = function(next) {
    return setTimeout(next, Math.floor(Math.random() * 1000));
  };

  testA = function(num) {
    return randsleep(function() {
      return simplelock('test', function(lockobj) {
        return randsleep(function() {
          console.log('testA' + num);
          return unlock(lockobj, function() {});
        });
      });
    });
  };
  ...
  testB = function(num) {
    return randsleep(function() {
      return simplelock('test2', function(lockobj) {
        return randsleep(function() {
  ...
  testC = function(num) {
    return randsleep(function() {
      return simplelock('test3', function(lockobj) {
        return randsleep(function() {
  ...
  testD = function(num) {
    return randsleep(function() {
      return multilock(['test', 'test2', 'test3'], function(lockobj) {
        return randsleep(function() {
  ...
  testrwA = function(num) {
    return randsleep(function() {
      return readerlock('test', function(lockobj) {
        return randsleep(function() {
          console.log('testA' + num);
          return unlock(lockobj, function() {});
        });
  ...
  testrwC = function(num) {
    return randsleep(function() {
      return pwrlock('test', function(lockobj) {
        return randsleep(function() {
          return writerlock(lockobj, function(lockobj) {
  ...
  testrwD = function(num) {
    return randsleep(function() {
      return writerlock('test', function(lockobj) {
        console.log('testD' + num);
        return unlock(lockobj, function() {});
      });
    });
  ...
  testrangeA = function(num) {
    return randsleep(function() {
      return rangereaderlock('test', 0, 2, function(lockobj) {
        return randsleep(function() {
          console.log('testA' + num);
          return unlock(lockobj, function() {});
        });
  ...
  testrangeB = function(num) {
    return randsleep(function() {
      return rangereaderlock('test', 0, 1, function(lockobj) {
        return randsleep(function() {
          console.log('testB' + num);
          return unlock(lockobj, function() {
            return randsleep(function() {
              return randsleep(function() {
                return rangereaderlock('test', 1, 2, function(lockobj) {
                  return randsleep(function() {
                    console.log('testBB' + num);
                    return unlock(lockobj, function() {
                      return randsleep(function() {
                        return randsleep(function() {
                          return rangereaderlock('test', 2, 3, function(lockobj) {
                            return randsleep(function() {
                              console.log('testBBB' + num);
                              return unlock(lockobj, function() {
                                return randsleep(function() {
  ...
  testrangeC = function(num) {
    return randsleep(function() {
      return rangepwrlock('test', 0.5, 2.0, function(lockobj) {
        return randsleep(function() {
          return rangewriterlock(lockobj, 1.2, 1.8, function(wlockobj) {
            console.log('testC' + num);
            return unlock(wlockobj, function() {
              return randsleep(function() {
                return unlock(lockobj, function() {});
              });
            });
  ...
  testrangeD = function(num) {
    return randsleep(function() {
      return rangewriterlock('test', 2.2, 2.3, function(lockobj) {
        console.log('testD' + num);
        return unlock(lockobj, function() {});
      });
    });
  ...
  init({}, function() {
    var i, j, k, l, results, results1, results2;
    if (false) {
      results = [];
      for (i = j = 0; j <= 5; i = ++j) {
        testA(i);
